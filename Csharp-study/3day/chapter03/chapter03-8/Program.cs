...
class Program
{
    static void Main(string[] args)
    {
         ...
         * if문에 중괄호({})가 있는 경우 구문을 1개이상 구문이 실행
         *   cf) 구문의 단위는 ';'로 구분
         */
        ...
        // 문제1. 변수 age가 20 이상이고 hasLicense가 true일 경우 '운전 가능'을 출력 false일 경우 '운전 불가'를 출력
        int age = 30;
        bool hasLicense = true;
        
        // ans1
        if (age >= 20 && hasLicense) Console.WriteLine("운전 가능");
        else Console.WriteLine("운전 불가");

        // ans2
        string result_drive = (age >= 20 && hasLicense) ? "운전 가능" : "운전 불가";
        Console.WriteLine(result_drive);
        ...
        // ans2
        string result_rest = (isWeekend || isHoliday) ? "쉬는 날입니다." : "일하는 날입니다.";
        Console.WriteLine(result_rest);
    }
}