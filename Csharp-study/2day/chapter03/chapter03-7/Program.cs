...
class Program
{
    static void Main(string[] args)
    {
        ...
        // ex) A OR(||) B : OR연산자는 A와B의 논리값이 하나라도 true이면 결과는 true
        int value2 = 10;
        int n3 = value2 % 3;    // 1
        int n4 = value2 % 5;    // 0
        ...
        bool result12 = (n11 % 3 == 0 && n12 % 3 == 0); // 6은 3의 배수이고 10이 3의 배수이면 true
        Console.WriteLine("n11값이 3의 배수이고(AND) n12는 3의 배수: " + result12);    // False

        // 문제1. 다음 조건을 만족하는 논리 연산을 사용하여 맞으면 'true' 출력 틀리면 'false'
        //   조건: 변수 age가 70 이상이고 hasLicense가 ture일 경우 'true' 틀리면 'false'
        int age = 40;
        ...
        Console.WriteLine((temperature >= 20 && temperature <= 30) && isRainy); // !(isRainy == false)
    }
}